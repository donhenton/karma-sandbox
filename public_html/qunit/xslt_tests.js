...
$(function () {
    ...
    module("xslt_tests.js xslt simple tests", {
    ...
    test('test load of sample xml by null', function (assert) {
    ...
    test('test load of sample by string', function (assert) {
    ...
    test('xsl worked', function (assert) {
